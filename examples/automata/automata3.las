...
#pos({},{},{:- accepted. length(4). time(1..4). word(1,a). word(2,b). word(3,a). word(4,a).}).  % "abaa"
#pos({},{},{:- accepted. length(4). time(1..4). word(1,a). word(2,a). word(3,b). word(4,b).}).  % "aabb"
#pos({},{},{:- accepted. length(4). time(1..4). word(1,b). word(2,a). word(3,a). word(4,b).}).  % "baab"
#pos({},{},{:- accepted. length(4). time(1..4). word(1,a). word(2,b). word(3,b). word(4,a).}).  % "abbab"
#pos({},{},{:- accepted. length(5). time(1..5). word(1,a). word(2,b). word(3,a). word(4,b). word(5,b).}).  % "ababb"
#pos({},{},{:- rejected. length(2). time(1..2). word(1,a). word(2,b).}).  % "ab"
#pos({},{},{:- rejected. length(4). time(1..4). word(1,a). word(2,b). word(3,a). word(4,b).}).  % "abab"
#pos({},{},{:- rejected. length(6). time(1..6). word(1,a). word(2,b). word(3,a). word(4,b). word(5,a). word(6,b).}).  % "ababab"


%% example 2 (aaa)^*
#pos({},{},{:- accepted. length(1). time(1..1). word(1,b). }). 
#pos({},{},{:- accepted. length(1). time(1..1). word(1,a). }). 
#pos({},{},{:- accepted. length(2). time(1..2). word(1,a). word(2,a). }). 
#pos({},{},{:- accepted. length(2). time(1..2). word(1,a). word(2,b). }). 
#pos({},{},{:- accepted. length(2). time(1..2). word(1,b). word(2,b). }). 
#pos({},{},{:- accepted. length(2). time(1..2). word(1,b). word(2,a). }). 
#pos({},{},{:- accepted. length(3). time(1..3). word(1,b). word(2,a). word(3,a). }). 
#pos({},{},{:- accepted. length(3). time(1..3). word(1,a). word(2,b). word(3,a). }). 
#pos({},{},{:- accepted. length(3). time(1..3). word(1,a). word(2,a). word(3,b). }). 
#pos({},{},{:- accepted. length(4). time(1..4). word(1,a). word(2,a). word(3,a). word(4,a). }). 
#pos({},{},{:- accepted. length(4). time(1..4). word(1,a). word(2,a). word(3,b). word(4,a). }). 
#pos({},{},{:- accepted. length(5). time(1..5). word(1,a). word(2,a). word(3,a). word(4,a). word(5,a). }). 
#pos({},{},{:- rejected. length(3). time(1..3). word(1,a). word(2,a). word(3,a). }). 
#pos({},{},{:- rejected. length(6). time(1..6). word(1,a). word(2,a). word(3,a). word(4,a). word(5,a). word(6,a). }). 
